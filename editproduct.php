...
?>
     <div class="d-none" id="edit-product-id"><?php echo ($id); ?></div>
    <div class="row">
        <div class="col-2 <?php if ($image1) {
                                echo ("d-none");
                            } else {
                                echo ("d-flex");
                            }; ?> justify-content-center align-items-center " id="productAddbtn-ed1">
        ...
        <div class="col-2 <?php if ($image2) {
                                echo ("d-none");
                            } else {
                                echo ("d-flex");
                            }; ?> justify-content-center align-items-center " id="productAddbtn-ed2">
        ...
        <div class="col-2 <?php if ($image1) {
                                ...
                                echo ("d-none");
                            }; ?>  justify-content-center align-items-center" id="productAddCon-ed1">
            <div class="d-flex flex-column">
                ...
                <img src="<?php if ($image1) {
                                echo ($image1);
                            } else {
                                echo ("");
                            }; ?>" class="productAdd" id="productAddId-ed1">
            </div>
        </div>
        <div class="col-2 <?php if ($image2) {
                                echo ("d-flex");
                                ...
                                echo ("d-none");
                            }; ?>  justify-content-center align-items-center " id="productAddCon-ed2">
            <div class="d-flex flex-column">
                ...
                <img src="<?php if ($image2) {
                                echo ($image2);
                            } else {
                                echo ("");
                            }; ?>" class="productAdd" id="productAddId-ed2">
            </div>
        </div>
            ...
            <div class="d-flex justify-content-center ">
                <div class="  d-flex flex-row py-4">
                    ...
                    <select class="form-control " style="width: 15vw;" id="product-cat-add-ed">
                        ...
                        ?>
                                <option value="<?php echo ($data1['cat_id']) ?>" <?php if ($data1['cat_id'] == $cat) {
                                                                                        echo ("selected");
            ...
            <div class="d-flex justify-content-center ">
                <div class="  d-flex flex-row py-4">
                    ...
                    <select class="form-control " style="width: 15vw;" id="product-brand-add-ed">
                        ...
                        ?>
                                <option value="<?php echo ($data3['brand_id']) ?>" <?php if ($data3['brand_id'] == $brand) {
                                                                                        echo ("selected");
                                                                                    } ?>><?php echo ($data3['brand_name']) ?></option>
                        <?php
            ...
            <div class="d-flex justify-content-center ">
                <div class="  d-flex flex-row py-4">
                    ...
                    <select class="form-control " style="width: 15vw;" id="product-mod-add-ed">
                        ...
                        ?>
                                <option value="<?php echo ($data2['model_id']) ?>" <?php if ($data2['model_id'] == $model) {
                                                                                        echo ("selected");
                                                                                    } ?>><?php echo ($data2['model_name']) ?></option>
                        <?php
            ...
            <div class="d-flex justify-content-center ">
                <div class="  d-flex flex-row py-4">
                    ...
                    <select class="form-control " style="width: 15vw;" id="product-con-add-ed">
                        ...
                        ?>
                                <option value="<?php echo ($data4['condition_id']) ?>" <?php if ($data4['condition_id'] == $condition) {
                                                                                            echo ("selected");
                                                                                        } ?>><?php echo ($data4['condition_name']) ?></option>
                        <?php
                    ...
                    <select class="form-control  " style="width: 15vw;" id="product-clr-add-ed">
                        ...
                        if ($num_row4 > 0) {
                            for ($x = 0; $x < $num_row4; $x++) {
                                $data4 = $rs4->fetch_assoc();
                        ?>
                                <option value="<?php echo ($data4['clr_id']) ?>" <?php if ($data4['clr_id'] == $color) {
                                                                                        echo ("selected");
                                                                                    } ?>><?php echo ($data4['clr_name']) ?></option>
                        <?php
